...
public class ParentMapsActivity extends FragmentActivity implements OnMapReadyCallback {
        ...
        if (locationManager.isProviderEnabled(LocationManager.NETWORK_PROVIDER)) {
            ...
            locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 0, 0, new android.location.LocationListener() {
                ...
                public void onLocationChanged(Location location) {
                    ...
                    LatLng phagwara = new LatLng(latitude, longitude);
                    marker = new MarkerOptions().position(phagwara);
                    mMap.addMarker(new MarkerOptions().position(phagwara));
    ...
    private void updateLocation() {
        ...
        if (marker != null) {
            ...
            ref.child("ParentLocation").child(parentId).setValue(latitudeLongitude);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(phagwara,15));
        mMap.addMarker(new MarkerOptions().position(phagwara).title("Parent Location"));
